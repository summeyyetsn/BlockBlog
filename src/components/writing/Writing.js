...
import Tooltips from '../common/toolTip/ToolTip.module.css';
import './Writing.css';
...
if (!editor) {
  ...
  return (
    <>
      <div className='menu-bar fixed-writing-menu-bar'>
          <div>
        ...
        <div className='writing-right-buttons-div'>
          <button
    ...
    return (
      <div>
        ...
        <div className='editor-container'>
            <EditorContent  editor={titleEditor} className='title-content-container' />
            <EditorContent editor={editor} className='writing-content-container' />
        </div>
      </div>
    )
  }
